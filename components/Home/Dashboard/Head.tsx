...
import Search from "@/components/Layout/Header/Right/Search";
...
const Head = () => {
  ...
  return (
    <>
      {/* lap */}
      <div className="flex items-start justify-between gap-2 max-md:hidden">
      ...
      {/* mob */}
      <div className="flex items-center justify-center flex-col gap-4 md:hidden w-full">
        ...
        <div className="flex items-start w-full justify-between gap-2">
          ...
          {!formHover && (
            <>
              <button
                className={`text-base px-4 h-12 gap-2 flex items-center justify-center rounded-full text-black border border-off-white overflow-hidden group w-full`}
              >
                Departments
                <Icon icon="iconamoon:arrow-down-2" className="text-lg" />
              </button>
              <button
                className={`text-base px-4 h-12 gap-2 flex border border-off-white items-center justify-center rounded-full text-black  overflow-hidden group w-full`}
              >
                <Icon icon="cil:filter" className="text-lg" /> Filter
              </button>
            </>
