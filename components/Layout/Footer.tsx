...
const Footer = () => {
  ...
  return (
    <div
      className={`fixed bottom-6 left-1/2 -translate-x-1/2 bg-black px-3 py-2 rounded-full flex space-x-3 shadow-2xl z-50 transition-all duration-300 md:hidden ${
        visible
